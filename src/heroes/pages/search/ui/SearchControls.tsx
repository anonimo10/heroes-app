...
export const SearchControls = () => {
  ...
  const activeAccordion = searchParams.get("search-acordeon") ?? "";
      ...
      <div className="flex flex-col lg:flex-row gap-4 mb-8">
        ...
        <div className="relative flex-1">
          ...
          <Input
            ...
            className="pl-12 h-12 text-lg bg-white text-black placeholder:text-gray-400"
          ...
          <Button
            ...
            onClick={() => {
              if (activeAccordion === "advance-filters") {
                setQueryParams("search-acordeon", "");
                return;
              }
              setQueryParams("search-acordeon", "advance-filters");
            }}
          >
            ...
            <div className="bg-white rounded-lg p-6 mb-8 shadow-sm border">
              ...
              <div className="mt-4">
                <label className="text-sm font-medium">
                  Minimum Strength: {selectStrength}
                </label>
